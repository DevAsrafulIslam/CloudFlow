  ...
  return (
    <div className="container mt-[120px]">
      <div className=" flex justify-between">
        <h1 className="text-2xl lg:text-[43px] mb-[60px] font-bold w-full text-center md:text-start md:w-6/12 leading-[55.9px] text-[#140B43]">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 md:gap-8 mb-4">
        <div className="shadow-xl hover:shadow-none border-b-4 border-transparent  hover:border-[#95D5EE] overflow-hidden  rounded-3xl">
          ...
          <div className="card-content px-2 md:px-10 flex  gap-1 justify-between">
          ...
          <div className="px-10">
            ...
            <div className="flex items-center gap-2 mb-10 pt-8 text-[22px] font-bold text-[#140B43]">
